...
def SUB_FOR_SUB(func):
    async def function(client, message):
        ...
        vars = "-1001987910807"  # isi id gc atau username yg mau di pakai buat join member (bisa lebih dari 1 fsub nya)
        if not vars:
...
Sfs Back PC <a href="tg://user?id=1365496750">˹ᴍɪᴋɪ • ᴍɢs˼ 𒂟⋆</a></b>
""",
